...
######only for this application###############################################
    ind_pa = "/raid/datasets/msr-vtt/index_folder_" + model[-2:]
    embedding_pa = "/raid/datasets/msr-vtt/scene_embeddings_" + model[-2:]
    #all_vids
    path = "/raid/datasets/msr-vtt/all_vids/"
################################################################################
...
with gr.Interface(fn=retrieval,
                  inputs=[gr.inputs.Textbox(label="Text", lines=2, placeholder="Text Here..."),
                          gr.inputs.Dropdown(label="Model", choices=["microsoft/xclip-base-patch32", "microsoft/xclip-base-patch16", "microsoft/xclip-large-patch14"])],
